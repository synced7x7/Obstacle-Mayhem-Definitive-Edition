...
public class eclipseofDespairBehaviour : MonoBehaviour
{
    public static eclipseofDespairBehaviour Instance { get; private set; }
    ...
    public void eclipseOfDespairMapActivator()
    {
        spriteRenderer.enabled = true;
    }
    public void eclipseOfDespairMapDeactivator()
    {
        spriteRenderer.enabled = false;
    }
    public void EclipseOfDespairFade(float timeBetweenFade, float fadeDuration, Color targetColor)
    {
