...
public class tornadoTwist_2_StateMachineBehaviour : StateMachineBehaviour
{
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        if (!updateDisabled)
        {
            ...
            {
                updateDisabled = true;
                animator.SetBool("Tornado Twist 3", true);
            }
        }
    }
    ...
    {
        animator.SetBool("Tornado Twist 2", false);
        if (!animator.GetBool("Tornado Twist 3"))
        {
