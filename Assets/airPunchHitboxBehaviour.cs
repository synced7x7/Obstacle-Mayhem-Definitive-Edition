...
public class airPunchHitboxBehaviour : MonoBehaviour
{
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.gameObject.layer == targetLayerMask)
        {
            ...
            {
                Debug.Log("Air punch activated.");
                sprite.hurtaction(Kyo_spriteActivator.Action.face_hurt, 0f, 0f, Color.white, 0.1f);
