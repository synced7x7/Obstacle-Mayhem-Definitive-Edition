...
public class RiotOfTheBloodSPBehaviour : MonoBehaviour
{
    public static RiotOfTheBloodSPBehaviour Instance { get; private set; }
    ...
    [SerializeField] private float timeBetweenFade = 0.3f;
